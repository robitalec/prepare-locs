...
# Input
Note: this workflow only processes files if it finds they at the specified path in metadata. This means you can add a row describing your own input data to `metadata()`
